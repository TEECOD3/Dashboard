...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-auto w-full items-center justify-between rounded-md border border-grey-white bg-white px-3 py-4 text-sm ring-offset-main-blue placeholder:text-space-cadet/50 focus-visible:outline-none focus:outline-none focus:ring-1 focus:ring-main-blue focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 dark:border-neutral-800 dark:bg-neutral-950 dark:ring-offset-neutral-950 dark:placeholder:text-space-cadet/50 dark:focus:ring-neutral-300",
      className
    )}
    {...props}
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ArrowDownIcon className="text-charleston" />
