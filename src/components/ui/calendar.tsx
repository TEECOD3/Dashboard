    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100  rounded-full border-[1px]"
        ),
        ...
        day_selected:
          "bg-white border-[#0294E2] border-[1px] rounded-full  text-neutral-50 hover:bg-[#0294E2] hover:text-neutral-50 focus:bg-[#0294E2] focus:text-neutral-50 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50 dark:hover:text-neutral-900 dark:focus:bg-neutral-50 dark:focus:text-neutral-900",
        day_today:
      ...
      components={{
        IconLeft: ({ ...props }) => (
          <ChevronLeft className="h-4 w-4 rounded-full" color="#1C334D" />
        ),
        IconRight: ({ ...props }) => (
          <ChevronRight className="h-4 w-4 rounded-full" />
        ),
      }}
      {...props}
    />
